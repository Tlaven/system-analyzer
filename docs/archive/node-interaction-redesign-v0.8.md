...
> **⛔ DEPRECATED — v0.8 历史文档,2026-06-20 归档**
>
> 权威实现以 `CLAUDE.md` + `docs/architecture.md` 为准。
> 本文档保留作 v0.8 设计意图参考(节点身份字段、Ctrl+C/V、拖边交互等设计动机仍有效),
> 但**边模型相关章节(原第 3、4、5、8、9 节)已过时**——v0.9 把边从 class 级迁到实例级 `attrs.edges` 数组,
> 详见 [ADR-001](../decisions/adr-001-instance-level-edges.md)。
>
> 不再维护,不据此写新代码。
